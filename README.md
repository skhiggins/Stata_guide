...
## Graphing
  * Sean wrote an .ado file called graph_options.ado to control the formatting of graphs in stata. Use the local macros generated by `graph_options` to ensure a clean formatting of your graphs, including a white background, sufficiently large text, axis lines only at x=0 and y=0, and no gridlines or tickmarks.
